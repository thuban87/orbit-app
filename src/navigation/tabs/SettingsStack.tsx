...
import type { SettingsStackParamList, SettingsScreenProps } from "../types";

const Stack = createNativeStackNavigator<SettingsStackParamList>();

function CustomFieldsRoute({ navigation }: SettingsScreenProps<"CustomFields">) {
...
export function SettingsStack() {
  return (
    <Stack.Navigator initialRouteName="Settings" screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="LegacyContactPicker" component={LegacyContactPickerScreen} />
