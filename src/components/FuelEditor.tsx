 ...
 *
 * Historical `source` values do not create a separate editor state. AI drafting
 * lives in Compose, so every persisted row uses the same add/edit/delete surface.
 */
