...
2. **[Resolved migration numbering]** Phase 15 = 005 (`digest_enabled`), Phase 16 = 006 (normalized custom-field values), and Phase 17 = 007 (generic tombstones). This supersedes the research-era reservation of 005/006 for tombstones.
...
- `.planning/phases/15-weekly-digest/15-CONTEXT.md`, `15-UI-SPEC.md`; `.planning/config.json`; `.planning/sync-milestone/PHASE-17-SYNC-READINESS.md` (settled Phase-16/17 prerequisite order).
