...
Plans:
- [ ] 36-01-PLAN.md — TRACER: migration 029 (AI-config schema) + AiProviderId reshape + master toggle + multi-connection + availability, direct-BYOK lane end-to-end (AICFG-01/02/03/05)
- [ ] 36-02-PLAN.md — OpenRouter lane: OAuth PKCE browser-auth + model catalog + live pricing (AICFG-04)
- [ ] 36-03-PLAN.md — Prompt assembly: render carry-only egress (shared memories + gated notes, NO off-limits/ADR-107) + Adjust + retire legacy AI-fuel confirm (AICFG-08/09/15/17)
- [ ] 36-04-PLAN.md — Central AI permission manager: type defaults + review + bulk disable/impact-gated enable (AICFG-10)
- [ ] 36-05-PLAN.md — Three-lane connection & model UI + Needs Attention/repair (AICFG-02/03/05/15)
- [ ] 36-06-PLAN.md — Writing Style + Personalization Context (paste/import) + token/context/cost estimate, explicit overflow (AICFG-06/07)
...
- [ ] 36-08-PLAN.md — FINAL: backup wire-format v5 bump + full milestone entity/preference serialization + restore validation/orphan-repair (AICFG-16/17)
**UI hint**: yes
