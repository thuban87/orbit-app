...
- [x] 38.1-08-PLAN.md — Contacts Grid excerpt removal (§L) [wave 1]

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 38.1-03-PLAN.md — Orrery nav split + apply overlay treatment (§B/§C, D-04) [wave 2, dep 01]
- [x] 38.1-04-PLAN.md — Vertical Year heatmap + timestamp offender reformats (§J/§K, D-08) [wave 2, dep 02]
- [x] 38.1-06-PLAN.md — Most Recent/Previous temporal knowledge + heading-level edit affordances (§F/§G, D-06) [wave 2, dep 05]
