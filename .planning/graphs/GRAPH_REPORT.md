...
## Corpus Check
- 586 files · ~477,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4093 nodes · 11631 edges · 203 communities (163 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d1db837`
...
- `AppShell()` --calls--> `subscribeAppState()`  [EXTRACTED]
  App.tsx → src/stores/assist-store.ts
...
Cohesion: 0.06
Nodes (70): makeContact(), uid(), contact(), email(), phone(), uid(), contact(), method() (+62 more)

### Community 1 - "types.ts"
Cohesion: 0.05
Nodes (62): buildExportManifest(), migrated(), PHOTO, uidFactory(), db(), fs, text, uidFactory() (+54 more)

### Community 2 - "field-types.ts"
Cohesion: 0.21
Nodes (10): CustomIntervalResult, IntervalUnit, parseCustomInterval(), UNIT_FACTORS, FrequencyPickerProps, PRESET_VALUES, PRESETS, styles (+2 more)
...
Cohesion: 0.05
Nodes (58): AppShell(), styles, resumeImport(), ResumeImportPrompt(), ResumeImportPromptProps, RootNavigation, styles, ResumeReconcilePromptProps (+50 more)
...
Cohesion: 0.15
Nodes (17): getImpactInputs(), ImpactInputs, computeGravity(), GravityInteraction, GravityResult, GravityTier, GravityTunables, parseLocalMs() (+9 more)
...
Cohesion: 0.10
Nodes (41): addMethodDraft(), choosePrimary(), emptyMethodDraft(), removeMethodDraft(), resolveEffectivePhoneRegion(), updateMethodDraft(), FrequencyPicker(), LinkDraft (+33 more)
...
### Community 20 - "Logger"
Cohesion: 0.13
Nodes (18): PhotoSourcePickerProps, setContactPhoto(), CropGeom, CropPhotoScreen(), styles, clamp(), CropRect, cropRectFromTransform() (+10 more)
...
Cohesion: 0.07
Nodes (27): App Shell, Applying destructive emphasis, Applying relationship-state emphasis, Architecture, Bootstrapping normalized-method migration, Changelog, Composing from a contact, Configuration (+19 more)

### Community 27 - "OrreryScreen.tsx"
Cohesion: 0.14
Nodes (19): isBulkActionAvailable(), actionLabels, BulkAction, CandidateCardGrid(), CandidateCardGridProps, CandidateChoice, CandidateItem, styles (+11 more)
...
Cohesion: 0.10
Nodes (32): OrbitBody(), OrbitBodyProps, SegmentedControl(), SegmentedControlOption, SegmentedControlProps, styles, getContactStatus(), listOrbitingContacts() (+24 more)

### Community 31 - "localDateTime"
Cohesion: 0.15
Nodes (17): main(), renderSeedModule(), SEED_PATH, CATALOG_PROVIDERS, dedupe(), filterLiteLLMCatalog(), GEMINI_SOURCES, isDeprecated() (+9 more)
...
Cohesion: 0.10
Nodes (20): CatalogFetch, CatalogFetchResponse, CatalogStorage, isEmptyCatalog(), isModelCatalog(), loadCachedCatalog(), RefreshDeps, refreshModelCatalog() (+12 more)
...
Cohesion: 0.06
Nodes (51): migrations, newUid(), photoMocks, AI_DEFAULTS, BACKUP_DEFAULTS, IsNever, KeysOverlap, migrateToV2() (+43 more)
...
Cohesion: 0.18
Nodes (9): seedBenchmarkData(), byDisplayOrder(), defsForCreateForm(), isLive(), visibleDefsForProfile(), recreateIndexes(), chain, withMutex() (+1 more)
...
Cohesion: 0.07
Nodes (42): canonicalDuplicateCopy(), collapseCanonicalDuplicate(), ContactMethodEditorDraft, discardBlankMethodDrafts(), EMPTY_METHOD_GROUPS, MethodGroups, MethodLabel, seedMethodDraft() (+34 more)
...
Cohesion: 0.06
Nodes (57): EVENT_LABELS, styles, TimelineRow(), TimelineRowProps, captureMultiAttach(), captureMultiNote(), listActionablePrimaryMethods(), listContactMethodGroups() (+49 more)
...
Cohesion: 0.15
Nodes (20): BirthdayNotificationCandidate, DecayEligibleCandidate, listBirthdayNotificationCandidates(), listDecayEligibleCandidates(), localDateOffset(), OVERDUE(), ROGUE(), seedContact() (+12 more)
...
Cohesion: 0.06
Nodes (50): pickContacts(), CatalogProvider, asCatalogProvider(), better(), EMPTY, filterToFrontier(), FRONTIER_TIERS, FrontierTier (+42 more)

### Community 64 - "transaction.ts"
Cohesion: 0.22
Nodes (10): ActiveLink, Choice, styles, ADR-0003, reconcileStagingRelPath(), digest(), promoteReconcilePhoto(), ReconcilePhotoFs (+2 more)
...
Cohesion: 0.05
Nodes (59): newUid(), seedContact(), seedFlag(), newUid(), seedContact(), seedImportRow(), ImportMatchOutcome, setRowContactCore() (+51 more)
...
Cohesion: 0.05
Nodes (53): AssistBanner(), questionFor(), styles, AssistConfirmation(), AssistConfirmationProps, styles, EndpointSelector(), EndpointSelectorProps (+45 more)
...
Cohesion: 0.08
Nodes (49): canonicalFor(), customFieldValueForTarget(), isPhotoWidgetEnabled(), PhotoFieldWidget(), styles, confirmRemovePhoto(), PhotoSourcePicker(), assertSafeImportStagingRelative() (+41 more)
...
Cohesion: 0.08
Nodes (21): isContactPickerAvailable(), PickContactsOptions, PickedContact, PickedMethod, readAllContacts(), readContactsByLookupKeys(), SelectedReadResult, OrbitContactPickerModule (+13 more)
...
Cohesion: 0.19
Nodes (15): isSafeColName(), makeColName(), slugify(), assertTextValue(), fail(), FIXED_LEGACY_COLUMNS, loadAndValidateDefs(), proveCopy() (+7 more)
...
Cohesion: 0.01
Nodes (138): ADR-0004, ADR-0005, ADR-0006, ADR-0007, ADR-0008, ADR-0009, ADR-0010, ADR-0011 (+130 more)
...
Cohesion: 0.11
Nodes (44): insertContact(), acknowledgeProvider(), setInteractionAssistEnabled(), assertPositiveCadence(), bindContact(), unbindContact(), archiveContact(), clearContactPhoto() (+36 more)

### Community 137 - "File"
Cohesion: 0.06
Nodes (77): ConsolidationPrompt(), sourceName(), SourcePreview(), SourceSnapshot, styles, acceptImportSessionWithRows(), AcceptImportSessionWithRowsInput, assertOneChange() (+69 more)
...
Cohesion: 0.05
Nodes (76): finishActivity(), Avatar(), AvatarProps, styles, GravityBar(), GravityBarProps, styles, Counts (+68 more)
...
Cohesion: 0.07
Nodes (36): BenchmarkResult, nowMs(), runBenchmark(), SeedOptions, ArchivedContactRow, listArchived(), expoExecutor(), openAndMigrate() (+28 more)
...
Cohesion: 0.10
Nodes (30): contact(), link(), uid(), ReconcileCardStatus, ReconcileSessionStatus, getReconcileSessionById(), listReconcileSessionCards(), mapCard() (+22 more)
...
## Knowledge Gaps
- **1267 isolated node(s):** `styles`, `SchedulableTriggerInputTypes`, `AndroidImportance`, `AndroidNotificationVisibility`, `scheduled` (+1262 more)
...
- **Why does `useTheme()` connect `sun-picker-read.test.ts` to `field-types.ts`, `001-initial.ts`, `import-session-read.ts`, `getExecutor`, `HomeScreen.tsx`, `File`, `backup-service.ts`, `index.ts`, `reconcile-apply.ts`, `ReconcileGridScreen.tsx`, `Logger`, `OrreryScreen.tsx`, `contacts-dao.ts`, `SettingsScreen.tsx`, `impact.ts`, `BackupScreen.tsx`, `create-contact-logic.ts`, `ContactProfileScreen.tsx`, `contact-import-resume-sweep.ts`, `CaptureScreen.tsx`, `fuel-dao.test.ts`, `transaction.ts`, `model-registry.ts`, `transaction.ts`, `CreateContactScreen.tsx`, `use-read-contacts-permission.ts`, `ReconcileDetailScreen`, `saf-storage.ts`, `reconcile-session-read.ts`, `notification-actions.test.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `SqlExecutor` connect `types.ts` to `database.ts`, `linking.ts`, `HomeScreen.tsx`, `File`, `App.tsx`, `ResumeReconcilePrompt.tsx`, `sun-picker-read.test.ts`, `model-catalog-filter.ts`, `restore-apply.ts`, `reconcile-apply.ts`, `ReconcileGridScreen.tsx`, `field-type-change.test.ts`, `backup-service.ts`, `SettingsScreen.tsx`, `app-settings-dao.ts`, `photo-storage.ts`, `notification-schedule.test.ts`, `reconciliation.ts`, `phase-17-runtime-integration.test.ts`, `RestorePreviewScreen.tsx`, `ContactProfileScreen.tsx`, `contact-import-resume-sweep.ts`, `Avatar.tsx`, `assist-store.ts`, `computeRingReorder`, `fuel-dao.test.ts`, `File`, `model-registry.ts`, `ImportReviewScreen.tsx`, `recency-dao.test.ts`, `CreateContactScreen.tsx`, `survivor-recommendation.ts`, `buildDecayRequest`, `contact-read.test.ts`, `queries.test.ts`, `BackupSettingsScreen.tsx`, `EditContactScreen.tsx`, `contact-read.test.ts`, `use-read-contacts-permission.ts`, `field-sweep.test.ts`, `ReconcileDetailScreen`, `saf-storage.ts`, `PhotoFieldWidget.tsx`, `recency-dao.ts`, `contacts-dao.test.ts`, `dashboard-read.test.ts`, `seedFullContact`, `006-normalize-custom-field-values.test.ts`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `inWriteTransaction()` connect `linking.ts` to `database.ts`, `types.ts`, `File`, `App.tsx`, `backup-service.ts`, `sun-picker-read.test.ts`, `restore-apply.ts`, `ReconcileGridScreen.tsx`, `Logger`, `app-settings-dao.ts`, `notification-schedule.test.ts`, `BackupScreen.tsx`, `phase-17-runtime-integration.test.ts`, `ContactProfileScreen.tsx`, `fuel-dao.test.ts`, `File`, `transaction.ts`, `ImportReviewScreen.tsx`, `CreateContactScreen.tsx`, `BackupSettingsScreen.tsx`, `EditContactScreen.tsx`, `ReconcileDetailScreen`, `recency-dao.ts`, `contacts-dao.test.ts`?**
...
- **Should `database.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.05789782736347622 - nodes in this community are weakly interconnected._
