...
status: planned
stopped_at: Completed 38.1-06-PLAN.md
last_updated: "2026-09-20T06:07:13.705Z"
...
state_head: 244238eb1f1b42770f4b6e3644f51f2c9ca3801f
progress:
  total_phases: 23
  completed_phases: 14
  total_plans: 186
...
Phase: 38.1 (profile-presentation-polish) — EXECUTING
Plan: 1/9 complete
Status: In progress
...
Last activity: 2026-09-19 — Phase 38 complete, transitioned to Phase 39
...
| Phase 25 P02 | 6m 47s | 3 tasks | 5 files |
| Phase 25 P04 | 5min | 3 tasks | 6 files |
| Phase 25 P05 | 5m 17s | 2 tasks | 4 files |
| Phase 25 P03 | 7m 33s | 3 tasks | 8 files |
| Phase 25 P06 | 7m | 3 tasks | 17 files |
| Phase 26 P01 | 1h 12m | 2 tasks | 14 files |
| Phase 26-dashboard-control-surface P02 | 5m | 2 tasks | 7 files |
| Phase 26 P03 | 6m | 2 tasks | 2 files |
...
| Phase 27 P01 | 1h 27min | 1 tasks | 10 files |
| Phase 27 P02 | 30m | 2 tasks | 8 files |
| Phase 27 P03 | 7min | 3 tasks | 5 files |
| Phase 27 P04 | 10min | 3 tasks | 8 files |
| Phase 27 P05 | 12min | 3 tasks | 5 files |
| Phase 27 P06 | 10min | 3 tasks | 10 files |
| Phase 27 P07 | 6min | 2 tasks | 3 files |
| Phase 27 P08 | 3min | 2 tasks | 4 files |
| Phase 28-dashboard-card-view P01 | 8min | 3 tasks | 4 files |
| Phase 28-dashboard-card-view P02 | 8m | 3 tasks | 8 files |
| Phase 28 P03 | 6min | 2 tasks | 2 files |
| Phase 28 P04 | 9min | 3 tasks | 5 files |
| Phase 28 P05 | 5m | 3 tasks | 4 files |
...
| Phase 29 P02 | 18min | 3 tasks | 16 files |
| Phase 29 P03 | 16min | 3 tasks | 16 files |
...
| Phase 31-profile-experience P14 | 24min | 3 tasks | 9 files |
| Phase 31 P15 | 14min | 3 tasks | 7 files |
...
| Phase 33-group-interaction-logging P01 | 25min | 5 tasks | 17 files |
| Phase 33-group-interaction-logging P02 | 16min | 2 tasks | 6 files |
| Phase 33 P03 | 69min | 4 tasks | 4 files |
| Phase 33 P04 | 12min | 2 tasks | 2 files |
| Phase 33 P05 | 8min | 3 tasks | 4 files |
...
| Phase 36 P01 | 1h 43m | 4 tasks | 22 files |
...
| Phase 36 P06 | 33min | 3 tasks | 14 files |
| Phase 36 P07 | 22min | 3 tasks | 14 files |
...
| Phase 37.1 P02 | 7min | 2 tasks | 10 files |
| Phase 37.1 P03 | 10min | 3 tasks | 9 files |
| Phase 37.1 P04 | 19min | 3 tasks | 11 files |
| Phase 37.1 P07 | 10min | 2 tasks | 10 files |
| Phase 37.1 P06 | 10min | 2 tasks | 13 files |
| Phase 37.1 P08 | 12min | 2 tasks | 12 files |
| Phase 37.1 P09 | 28min | 2 tasks | 3 files |
| Phase 37.1 P10 | 4min | 2 tasks | 2 files |
| Phase 37.1 P11 | 4min | 2 tasks | 2 files |
| Phase 37.1-category-management P12 | 7 min | 3 tasks | 7 files |
...
| Phase 38 P04 | 7min | 4 tasks | 10 files |
...
| Phase 38.1 P01 | 4min | 2 tasks | 3 files |
| Phase 38.1 P02 | 1 min | 1 tasks | 2 files |
| Phase 38.1-profile-presentation-polish P05 | 6min | 3 tasks | 11 files |
...
| Phase 38.1 P06 | 12min | 3 tasks | 23 files |
...
- [Phase 25]: Dashboard populations resolve through one scoped OR-union; archived and Unbound contacts remain structurally excluded.
- [Phase 25]: Birthday selection receives injected local read time, uses the shared parser, and applies sole-population ordering after the query.
- [Phase 25]: Corpus SQL accepts only eligible ids; search terms never enter SQL.
- [Phase 25]: Dashboard uses coverage-aware ranking while legacy all-terms ranking remains unchanged.
- [Phase 25]: Resolved eligible-id order, rather than a sort enum, breaks equal-relevance ties.
- [Phase 25]: Dashboard empty-state input keeps legacy fields and adds optional population-model fields so HomeScreen stays unchanged until Plan 07.
- [Phase 25]: Multi-selected empty special populations resolve deterministically through dedicated UI-SPEC causes before the Favourites fallback.
- [Phase 25]: Dashboard search text and scroll remain memory-only; Phase 26 composes clearSession with the durable query reset.
- [Phase 25]: Gravity remains a reversible post-query TypeScript pass; no cached column or SQL WHERE was added.
- [Phase 25]: Contact Frequency boundaries are centrally tuned as inclusive upper bounds: weekly 7, monthly 31, quarterly 91, yearly thereafter.
- [Phase 25]: Needs Attention owns snooze suppression while Active and Snoozed populations retain currently snoozed contacts.
- [Phase 25]: Favorites widget uses the shared Dashboard Default relationship-health order instead of favourite rank.
- [Phase 25]: favourite_rank remains internal storage; ranked Favorites UI and rewrite writer are retired.
- [Phase 25]: orbit://favourites safely resets to Home through an index-0 WidgetNavIntent until later render wiring.
- [Phase 26]: Dashboard panels use a root-level in-tree host so the scrim covers app-bar and list while triggers remain interactive.
- [Phase 26]: Population option content emits only a key intent; DashboardControlRow serializes writes from current Zustand state.
- [Phase 26]: Dashboard query hydration drops stale persisted snapshots after a newer setter advances generation.
- [Phase 26]: Filter and sort panel content emit only intent; DashboardControlRow owns serialized durable writes.
- [Phase 26]: DashboardControlRow refetches categories on focus to keep category filter labels current.
- [Phase 26]: Dashboard search applies A3 archived-only relaxation only for implicit Active population.
- [Phase 26]: Population list and search share birthday, sort, and gravity post-processing.
- [Phase 26]: Dashboard empty-state population counts are bound-only and filters-naive.
- [Phase 26]: 26-04: Dashboard overflow is fixed at five actions; Select Contacts remains disabled until Phase 28.
- [Phase 26]: 26-04: ShellAppBar owns intrinsic header-label fit and defaults destinations to compact before measurement.
- [Phase 26]: 26-04: Dashboard Reset clears session state only after durable query reset succeeds.
- [Phase 26]: Archived uses ShellAppBar child chrome so app-bar Back shares resolveBackIntent and native per-tab-stack behavior.
- [Phase 26]: Archived scrolls only its content below fixed chrome while preserving the ADR-018 archive-before-purge gate verbatim.
- [Phase 26]: Unbound retrieval replacement filters existing listUnbound rows locally, preserving its fixed SQL scope and ordering.
- [Phase 26]: Active Unbound search shows N matching, including zero; no active term shows the total unbound-contact label.
- [Phase 26]: Resolved Unbound content renders search before true-empty and no-match branches.
- [Phase 27]: ListRow is presentational only; HomeScreen captures one now value and owns data/navigation.
- [Phase 27]: List recency and snooze use shared DST-safe local-calendar helpers; malformed snooze text fails closed.
- [Phase 27]: Migration 020 stores dashboard_right_swipe_action as quick-log by default with a closed quick-log/log-contact CHECK set.
- [Phase 27]: The right-swipe portable key is allowlisted now but snapshot emission and backup-format changes remain Phase 36 work.
- [Phase 27]: Dashboard line-3 reads use per-contact bounded SQL windows with registry-aware TS visibility filtering and a post-filter re-cap.
- [Phase 27]: Semantic favorite now resolves globally to the star/star-outline pair for all current and future consumers.
- [Phase 27]: List favourite membership is a null/non-null favourite_rank test; rank is never read as order.
- [Phase 27]: The latest successful list-favourite write patches base rows before its reactive overlay clears, so membership persists without a reload.
- [Phase 27]: List line-three data is batched under HomeScreen reload's existing cancellation guard.
- [Phase 27]: Quick Log is an injected per-instance command shared by the FAB and Dashboard List swipe; no process-global pending guard.
- [Phase 27]: Dashboard List detailed actions use the typed LogContact/Edit root-navigation helper, while preference-read failure falls back to Quick Log with Retry.
- [Phase 27]: D-12: List-only corpus search preserves relevance-first scorer ordering; Card View remains on listDashboardSearch.
- [Phase 27]: Visible List search corpus excludes hidden relationships and hidden/outdated memories at the shared read boundary.
- [Phase 27]: Older successful favourite writes update the committed base even while a newer overlay remains visible.
- [Phase 27]: Only the latest failed mutation removes its overlay and exposes the already-patched base row.
- [Phase 27]: Local parser rejects components outside wall-clock ranges and dates Date would normalize through rollover.
- [Phase 27]: Malformed non-null List recency uses No interactions yet rather than allowing a parser exception to escape rendering.
- [Phase 28]: CardGrid owns a keyed responsive FlatList and explicitly receives the complete shared-list surface contract.
- [Phase 28]: GridCard is presentational while HomeScreen owns navigation and the existing optimistic favourite mutation path.
- [Phase 28]: Bulk operations compose non-mutexed contact cores in one outer transaction and bump data revision once.
- [Phase 28]: Bulk Quick Log pins canonical outbound/manual interaction columns and returns exact receipts for atomic undo.
- [Phase 28]: Dashboard selection is ephemeral and freezes its entry-time eligible universe; toggles reject out-of-universe ids.
- [Phase 28]: Bulk archive callers remove ids from both selectedIds and frozenUniverse so Select All cannot restore archived contacts.
- [Phase 28]: Card compactness only ranks candidates within List-compatible priority tiers.
- [Phase 28]: Any non-empty dashboard search produces shared descriptors before List/Card rendering diverges.
- [Phase 28]: Card menu and card-level accessibility actions share host-owned canonical callbacks.
- [Phase 28]: Card Log Interaction always routes directly to LogContact and never uses the dashboard list-swipe preference.
- [Phase 28]: Card snooze preserves profile's 3d/1w/1m choices and reconciles notifications after committed writes.
- [Phase 28]: Selection-mode rendering filters live Dashboard rows against the entry-time frozen universe before CardGrid receives them.
- [Phase 28]: Overflow selection awaits persisted Card View activation and skips selection when persistence fails.
- [Phase 28]: Android Back consumes its event to exit selection before route navigation.
- [Phase 28]: Bulk Quick Log uses its N-contact DAO receipt with undoBulkQuickLog, never the single-contact FAB undo controller.
- [Phase 28]: GroupLog receives optional serializable participantIds; Phase 33 owns consumption and persistence.
...
- [Phase 29]: 29-02: Independent migration 021 stores density, satellites and closed builtin/category-UID System preferences; no camera persistence or category existence FK.
- [Phase 29]: 29-02: Optional Orrery preferences restore through existing core; current format-4 export omits them until Phase 36.
- [Phase 29]: 29-03: Successful System membership remains usable after preference-save failure; current request generations own publication and persistence initiation.
- [Phase 29]: 29-03: Global sun identity is separate from System membership and satellite-parent eligibility; complete contacted rank inputs exclude neutral rows.
...
- [Phase 31]: Profile layout release callbacks use the existing parent-aware reducer while named Move controls remain the accessibility fallback.
- [Phase 31]: Profile template assignment uses the selected active local contact and preserves its independent background/category/contact axes.
- [Phase 31]: Profile background clears null only the intended background axis and preserve sibling layout data.
- [Phase 31]: Background clear and contact inherit controls remain reachable without selecting a saved template.
- [Phase 31.1]: Only the deepest Orrery route forces None/Solid; Orrery-tab browse children retain the System background.
- [Phase 31.1]: NavigationContainer supplies transparent scenes while screen roots reveal a single fixed shell host.
- [Phase 31.1]: Background selection remains package-local and database-persisted by a later Settings caller; no AsyncStorage source was added.
...
- [Phase 33]: Migration 026 uses only Channel/Tone/Duration follow flags; direction/connected are participant-owned.
- [Phase 33]: Same-group contact merges reject with typed remediation before reparenting; no child interaction is discarded.
- [Phase 33]: Phase 33 Plan 02: ContactPicker multi-select is a discriminated union; Group Event profile routes register in every hosting stack.
- [Phase 33]: Group Event inheritance follows only Channel, Tone, and Duration; Direction and Connected remain participant-owned.
- [Phase 33]: Event and participant multi-field saves compose recency cores and explicit follow-flag updates inside one transaction.
- [Phase 33]: Group Event browse/search reads group_events directly so parents never duplicate child interaction history.
- [Phase 33]: Group Event search escapes literal backslash, percent, and underscore before binding LIKE parameters.
- [Phase 33]: Participant read projections expose only Channel, Tone, and Duration follow flags; Direction and Connected remain participant-owned.
- [Phase 33]: Phase 33 restore orphans detach to standalone, clearing group_event_id and all three ge_follow flags together.
- [Phase 33]: Group Event lifecycle mutations compose recency and tombstone cores with one trailing data-revision bump.
- [Phase 33]: Phase 33 Plan 06: Group Log remains event-first with In Person default and no ordinary channel preference read.
...
- [Phase 35]: [35-04] AI lifecycle reshaped to ADR-079 three-suggestion contract (review:{suggestions: readonly string[]}), single-suggestion confirm-replace retired; ack gate removed cleanly (D-09), DAO ai_ack_* writer left forward-only; HIGH-2 egress-failure aborts controller before nulling so fan-out siblings cancel.
- [Phase 35]: [35-04] Three-suggestion MECHANISM = node-pure generateVariants fan-out (3 single-draft calls under one signal) + variantTemperature variation lever; AiService single-draft provider contract untouched (Phase 36 owns provider layer). ai-availability adapter is provisional D-12, stable interface Compose consumes.
- [Phase 36]: 36-01: Owner selected approve-retire-ack; migration 029 omits ai_ack_openrouter and acknowledgeProvider is retired under ADR-079.
- [Phase 36]: 36-01: ai_active_connection stores a lane natural key; empty or dangling pointers resolve to Needs Attention with no silent substitution.
- [Phase 36]: 36-01: OpenRouter uses the OpenAI-compatible no-output-cap default until a model-specific cap is supplied.
- [Phase 36]: 36-03: Render each permitted Memory and gated interaction note in its own DATA fence; never omit whole permitted items for the legacy total ceiling.
- [Phase 36]: 36-03: Keep Adjust guidance session-only and reuse the existing exactly-three Compose generation fan-out.
- [Phase 36]: 36-03: Remove the inert AI-fuel confirmation writer and UI state without changing ordinary fuel or Off Limits behavior.
- [Phase 36]: Creation defaults are resolved once at insert time so later default changes never rewrite existing permission state.
- [Phase 36]: Custom-field review is contact/value scoped, while permission writes deduplicate to definitions and impact counts expand to affected values.
...
- [Phase 36]: Structured Writing Style supersedes the legacy raw style note; the raw field remains compatibility fallback only.
- [Phase 36]: Personalization section enabled is the sole egress gate; display order is organizational and equal-weight.
- [Phase 36]: Context estimates use cached selected-model capacity and never invent an artificial ceiling when capacity is unknown.
- [Phase 36]: LiteLLM max_input_tokens remains separate from generation max_output_tokens.
- [Phase 36]: AI diagnostics use an explicit safe-metadata allowlist and discard raw failures before state or observability.
- [Phase 36]: Settings retains the whole immutable AI payload while Compose extracts exact contact DATA blocks from the same ResolvedPrompt used for egress.
- [Phase 36]: The first-use AI marker is device-local bookkeeping, excluded from portable settings and unrelated to retired ai_ack gates.
- [Phase 36]: Backup format v5 carries the complete milestone preference and entity graph and upgrades v4 exactly once.
- [Phase 36]: Profile background restore uses UID-keyed pending files and post-commit canonical persistence; restore_photo_journal remains unchanged.
- [Phase 36]: Missing Group Event parents repair interactions to ordinary contact history instead of dropping them.
- [Phase 36]: Model entry without an active lane routes to Connection because model selection requires provider-lane identity.
- [Phase 36]: Writing Style and Personalization Context share one focus-aware screen while remaining distinct Settings hub entries.
- [Phase 36]: Phase 36 Plan 11: Implemented the owner-approved on-device localhost callback; OpenRouter never receives the unsupported orbit:// callback.
- [Phase 36]: Phase 36 Plan 11: Retained orbit://openrouter-auth only as a credential-free foreground wake after native callback acceptance.
...
- [Phase 37.1]: 37.1-02: Category deletion fingerprints complete fallout and the surviving target catalog under the writer lock.
- [Phase 37.1]: 37.1-02: Custom Systems require a meaningful valid rule or explicit include override; empty and exclude-only definitions need attention.
- [Phase 37.1]: Format v6 adds only category deletion evidence; v5→v6 is an identity relabel in the existing migration chain.
- [Phase 37.1]: Category-tombstone fallout is normalized only for categories proven deleted, preserving historical missing-category diagnostics.
- [Phase 37.1]: Replace-all tombstones removed destination categories, clears live-survivor tombstones, and never reseeds taxonomy.
- [Phase 37.1]: Replace-all tombstones removed destination categories, clears live-survivor tombstones, and never reseeds taxonomy.
- [Phase 37.1]: 37.1-04: Anchored menus use measured modal placement with safe-area clamping and bounded scrolling.
- [Phase 37.1]: 37.1-04: Category manager mutations publish committed truth; deletion remains fingerprint-authorized at lock time.
- [Phase 37.1]: 37.1-07: Category-rule search filters rendered rows only while the complete UID-backed draft preserves hidden selections.
- [Phase 37.1]: 37.1-07: Orrery selector disclosure state resets from the selected System on every open and is never persisted.
- [Phase 37.1]: 37.1-07: Canonical System validity and malformed-rule diagnostics jointly drive Needs Attention, with count detail only for malformed rules.
- [Phase 37.1]: 37.1-07: Canonical System validity and malformed-rule diagnostics jointly drive Needs Attention, with count detail only for malformed rules.
- [Phase 37.1]: Dashboard uses the closed uncategorized sentinel plus positive decimal category IDs, shared by runtime and backup validation.
- [Phase 37.1]: Profile presentation category assignment remains real-category-only and uses complete bounded searchable sheets.
- [Phase 37.1]: 37.1-08: Category audit classifies local relationships as ID, portable/System relationships as UID/ref, and display/search/AI label reads as name.
- [Phase 37.1]: 37.1-08: MergeConflictsScreen remains an audited pre-existing screen-local SQL exception; DAO extraction is outside the audit closeout.
- [Phase 37.1]: Physical category UAT uses only ordinary production UI and aggregate/synthetic evidence; failure-path proof remains automated.
- [Phase 37.1]: Temporary Android motion, font, and accessibility changes require exact baseline capture and final readback.
- [Phase 37.1]: Phase 37.1 Plan 10: Category deletion treats durable dashboard_filters as untrusted and requires the canonical Dashboard parser before preview or mutation.
- [Phase 37.1]: Plan 37.1-11: CategoryChoiceSheet uses the canonical post-exclusion model threshold and suppresses stale queries below it.
- [Phase 37.1-category-management]: Initial and focus category reads share one monotonic generation authority; consumers own only the authorized commit callback. — This prevents independently completing reads from overwriting newer category truth.
- [Phase 37.1-category-management]: Category read failures preserve committed state and remain independent from non-category hydration and photo refresh. — A failed refresh must not erase catalog, selection, form, or draft state.
...
- [Phase 38]: Phase 38-03: D-10 broadens only an exact not-contacted selection; mixed and other populations remain Bound-only.
- [Phase 38]: 38-04: Digest taps use a distinct lookup-free select-digest intent; contact intents retain the guarded asynchronous lookup path.
- [Phase 38]: 38-04: Contacts-to-Events navigation crosses through the typed parent tab navigator and fails closed when that parent is absent.
- [Phase 38]: Phase 38 Plan 05: Your Week aggregate date counts populate the heatmap Map directly; buckets() is not used.
- [Phase 38]: Phase 38 Plan 05: Digest and Settings share yourWeekPeriod and synchronize through focus-time reload.
- [Phase 38]: Phase 38 Plan 06: Digest relationship rows use Avatar plus shared ringVisual instead of fabricating ContactCard fields.
- [Phase 38]: Phase 38 Plan 06: Contacts drill-through replaces populations and filters atomically before navigation.
- [Phase 38]: Phase 38 DEV UAT controls remain compile-time gated and cannot alter the production weekly Digest singleton.
- [Phase 38]: Canonical Never Contacted restoration preserves monotonic modified_at and data_revision advancement.
- [Phase 38.1]: 38.1-01: Orrery overlays use dedicated Galaxy 0.91 / Standard 0.87 tints with a 0.92 visibility ceiling; CARD_GLASS_OPACITY remains unchanged.
- [Phase 38.1]: 38.1-01: GlassSurface gains an opt-in orrery-overlay treatment; its default card path remains cardTintOpacity.
- [Phase 38.1]: Minute-precision timestamp display is centralized in dates.ts with one private 12-hour source and a neutral parse-failure fallback. — Preserves local wall-clock storage precision, prevents seconds from resurfacing, and leaves the future user toggle as a one-line setting change.
- [Phase 38.1]: Retired Profile header metadata; bodySummary now owns durable content state.
- [Phase 38.1]: Bound-only overflow Unbind reuses the existing confirmation and lifecycle transition.
- [Phase 38.1]: 38.1-07: Orphan stretch is a post-pack visual span only; it preserves saved module order and semantic sizes.
- [Phase 38.1]: 38.1-07: The existing compact/wide toggle remains authoritative; no new width controls were added.
- [Phase 38.1]: 38.1-08: Normal Grid omits routine line three at GridCard; CardGrid keeps its shared prop chain.
...
- [Phase 38.1]: Profile temporal preview uses a bounded is_current=0 LIMIT 5 read; full history stays in MemoryHistory.
- [Phase 38.1]: Off Limits editing is a dedicated scoped FuelEditor route guarded at the write path.
...
**Last session:** 2026-09-20T06:07:06.861Z
**Stopped at:** Completed 38.1-06-PLAN.md
...
- Plans 29-01 through 29-12 are complete and committed. Phase review/verifier and native acceptance remain pending.
- Plan 12 full regression passed: 275 files/2581 tests (`/tmp/orbit-29-12-tests-final.log`), plus 2 files/24 targeted tests, typecheck, color and four-file Biome checks. Multi-plan ORRC requirements remain pending. All 55 native state checks remain pending in `29-NATIVE-CHECKLIST.md`; WINDOWS entry 55 records the obligation.
