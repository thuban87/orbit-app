...
| 31-02-T3 | 31-02 Task 3 (TDD) | 2 | PROF-03/04/05/07 | T-31-04/05/06 | DAO reset/delete/collapse plus owner-selected two-axis Category-clear resolver/contact-writer tests are extended red before implementation | integration | `npx vitest run src/db/profile-presentation-dao.test.ts src/db/contacts-dao.test.ts src/profile/resolve-presentation.test.ts` | ❌ extend first | ⬜ pending |
