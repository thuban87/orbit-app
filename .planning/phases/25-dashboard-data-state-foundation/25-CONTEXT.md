...
- **D-11 (AF-08):** The "compact Card/Grid renderer" deferral is stale and struck — **Card View *is* the compact 3-column avatar-first grid**; nothing separate remains deferred.
