...
**Required by:** ADR-094 (Eligibility-Scoped Semantic Dashboard Search); ADR-105 (Scoped Relationship Satellites for System-Member Context); ADR-109 (Fixed-Hero Semantic Profile Composition and Focused Accessible Editors); ADR-110 (Coherent Local Profile Snapshot and Source-Owned Knowledge Projection)
