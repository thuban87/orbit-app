...
**Required by:** ADR-065 (Durable Resumable Contact-Import Sessions with Failure-Isolated Photos); ADR-112 (App-Owned Profile Background Derivatives and Launch Reconciliation).
