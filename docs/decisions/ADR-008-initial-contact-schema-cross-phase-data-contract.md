...
**Depends on:** None.
**Required by:** ADR-010 (Single-Writer Interaction Recency Spine); ADR-012 (Opt-Out Android Backup for Third-Party PII); ADR-013 (Runtime Two-Table Custom Fields with Whitelist-Constructed DDL).
