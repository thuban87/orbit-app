...
**Required by:** ADR-093 (Scoped Composable Dashboard Population and Filter Model); ADR-096 (Dashboard Header and Overflow Discovery Paths); ADR-147 (Derived Digest Composition and Canonical Contacts Drill-Through)
