...
**Required by:** ADR-106 (Derived Orrery Gravity Visual Mass and Accessible Context); ADR-111 (Cadence-Guarded Profile Metrics and Composed Relationship Actions)
