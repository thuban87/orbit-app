...
**Required by:** ADR-106 (Derived Orrery Gravity Visual Mass and Accessible Context); ADR-111 (Cadence-Guarded Profile Metrics and Composed Relationship Actions); ADR-119 (Reusable Count-Only History Aggregation and Canonical History Read)
