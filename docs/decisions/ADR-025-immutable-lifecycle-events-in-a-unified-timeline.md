...
**Required by:** ADR-103 (Atomic Composed Dashboard Bulk Mutations); ADR-111 (Cadence-Guarded Profile Metrics and Composed Relationship Actions); ADR-118 (Bind/Unbind Immutable Lifecycle Events Without a Migration); ADR-122 (Canonical Interaction Detail, Edit Route, and Shared Date Detail Sheet)
