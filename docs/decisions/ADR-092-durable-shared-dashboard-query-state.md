...
**Required by:** ADR-095 (Live-Applying Dashboard Floating Control Surface); ADR-099 (Durable Global Dashboard Right-Swipe Action); ADR-101 (Avatar-First Accessible Dashboard Card Renderer); ADR-102 (Frozen-Universe Dashboard Multi-Select)
