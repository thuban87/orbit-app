...
**Required by:** ADR-020 (Library-Only Photo Capture with Themed In-App Cropping and One-Time URL Download); ADR-036 (Entry-Agnostic Compose Navigation and Transmittable-Fuel Guardrails); ADR-037 (Text-Only Android Share Intent Integration)
