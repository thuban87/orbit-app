...
**[DERIVED]** AI Draft is not restored as a separate Profile action; later Messaging / AI Compose owns AI-assisted composition behavior behind Message (ADR-052 superseded 2026-09-01 by ADR-079: AI is reached via Message → Draft with AI, two taps).
