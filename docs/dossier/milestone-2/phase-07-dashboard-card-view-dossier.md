...
**Status:** complete · Interrogated through 2026-08-30 · Grid/Card renderer product decisions settled.
...
**[DECIDED]** Bulk Log Interaction with a detailed form is not offered.
...
- bulk detailed Log Interaction forms
- bulk Edit Contact
...
8. Ordinary bulk actions support Quick Log, explicit favorite/snooze operations, category assignment, and archive without introducing bulk detailed forms or bulk Edit.
