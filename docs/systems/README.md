...
| Categories | `categories.md` | `db/categories-dao.ts`, `logic/category-logic.ts`, `screens/CategoryManagementScreen.tsx`, `components/category/CategoryChoiceSheet.tsx` | 37.1 |
